...
void PLabel::createDockWindows()
{
    ...
    for(int iii = 4; iii < 100; iii++)
    {

        fontSizeBox1.addItem(QString::number(iii));
    }
...
//        int h_down=(int)(h/tableWidget->columnCount());
        //		m_center=new QGraphicsRectItem(0,scene);
...
void PLabel::loadFile(const QString &fileName)
{
    ...
    setWindowTitle("Label Software-"+lic_name+"-"+ tableWidget->getFileName());
}
...
void PLabel::on_actionClose_triggered()
{
    ...
    if(tableWidget)
    {
        ...
        delete tableWidget;
        tableWidget=NULL;
        setWindowTitle("Label Software-"+lic_name+"-");
...
void PLabel::on_actionNew_2_triggered()
{
    ...
    tableWidget->setCurrentCell(0,0);
    setWindowTitle("Label Software-"+lic_name+"-"+"New File");
...
void PLabel::on_actionUnderline_triggered()
{
    ComboCurrentActivated(0);
}
...
{
    //        lrectItem=new QMyGraphicsRectItem(0, scene);
    //		QPointF m_initPos;
